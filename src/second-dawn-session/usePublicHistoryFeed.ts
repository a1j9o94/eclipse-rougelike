...
export interface PublicHistoryRequest {beforeRevision?:number;fromStart?:boolean;limit:number}
export function usePublicHistoryFeed(
  key: string | null,
  latest: PublicHistoryPage | null | undefined,
  fetchPage: (request:PublicHistoryRequest)=>Promise<PublicHistoryPage|null>,
): HistoryFeed {
