...
/**
 * EclipseGalaxyBoard - Full Eclipse: Second Dawn galaxy map
 *
...
export default function EclipseGalaxyBoard({
  ...
  const getHexFill = (sector: EclipseSector): string => {
    ...
    if (sector.controlledBy) {
      // Player-controlled sectors (lighter shade)
      return '#1e40af'; // Blue tint
    }

    // Default explored sector
    return '#1f2937';
  };
