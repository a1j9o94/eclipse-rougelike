...
const presentations: Record<FactionId, Omit<FactionPresentation, "startingShip" | "blueprintSummary">> = {
  ...
  lyra:{overview:'Build a network of Shrines while researching, then turn completed rows into lasting bonuses.',benefits:[{icon:'structure',value:'9',label:'Shrines',detail:'During each Research action, you may place one Shrine in a controlled sector beside a matching or gray planet.'},{icon:'influence',value:'+1',label:'VP per controlled Shrine',detail:'Your Shrines stay on the board after losing control, but score only while you control their sector.'},{icon:'population',label:'Colony ship combat rerolls',detail:'Flip an unused colony ship to reroll one of your own combat dice.'}],constraints:['Shrines cost 2–4 Science, 3–5 Money, or 4–6 Materials by board space.','Completing a row grants Wormhole Generator, a discovery, or one influence disc.']},
  'rho-indi': {
