...
interface Props {enabled:boolean;paused:boolean;disabled:boolean;disabledReason?:string;onChange:(enabled:boolean)=>void}
export default function AutoPassControl({enabled,paused,disabled,disabledReason,onChange}:Props){
