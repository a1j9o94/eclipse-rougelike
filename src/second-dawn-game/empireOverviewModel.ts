...
import type {Action,SpectatorView,PlayerView,Resource} from '../../shared/eclipse/types';
...
export function empireOverviewModel(view:PlayerView|SpectatorView,seatId:string):EmpireOverviewModel {
 ...
 return {own:seatId===('viewerSeatId' in view?view.viewerSeatId:undefined),score:runningScore(view,seatId).breakdown.total,sectorCount:sectors.length,
