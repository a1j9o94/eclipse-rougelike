...
export function empireOverviewModel(view:PlayerView,seatId:string):EmpireOverviewModel {
 ...
 return {own:seatId===view.viewerSeatId,score:runningScore(view,seatId).breakdown.total,sectorCount:sectors.length,
  colonyShips:seat.colonyShipsAvailable,colonyShipCapacity:faction.colonyShips,influence:seat.influenceOnTrack,upkeep:upkeepForEmptyInfluenceSlots(13-seat.influenceOnTrack),tradeRatio:faction.tradeRatio,
