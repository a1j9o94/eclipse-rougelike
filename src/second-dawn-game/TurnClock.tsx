...
export default function TurnClock({timer,actorName,onRetry,disabled=false}:{timer:MultiplayerTimerPublic|null;actorName:string;onRetry?:()=>void;disabled?:boolean}){
