...
export default function MobileNavigation({selected,onSelect,onActions,pending,pendingLabel,onDecision,actionLabel,onBack,onDetails,onConfirm,onEndAction}:{selected:MobileDestination;onSelect:(destination:MobileDestination)=>void;onActions?:()=>void;pending:boolean;pendingLabel?:string;onDecision:()=>void;actionLabel?:string;onBack:()=>void;onDetails?:()=>void;onConfirm?:{label:string;disabled:boolean;submit:()=>void};onEndAction?:()=>void}){
