...
export default function FactionSymbol({faction,className=''}:{faction:FactionId;className?:string}){
 ...
 return <svg className={`dg-faction-symbol ${className}`} role="img" aria-label={`${definition.name} emblem`} data-civilization={definition.color} width="24" height="24" viewBox="0 0 24 24"><path d={EMBLEMS[definition.emblem]} fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"/></svg>;
}
