...
function ctx(): BattleCtx {
  return { rng: () => 0, rerollsThisRun: 0, status: { corrosion: new WeakMap(), painter: null, fleetTempShield: { P: null, E: null }, tempShield: new WeakMap(), oncePerCombat: new WeakMap() } }
}
