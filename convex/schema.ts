...
export default defineSchema({
  ...
  eclipseAiJobsV1: defineTable({
    ...
    lastPlanNodes: v.optional(v.number()),
    lastPlanDepth: v.optional(v.number()),
    lastPlanCutoff: v.optional(v.boolean()),
    lastSearchNodes: v.optional(v.number()),
    lastSearchDepth: v.optional(v.number()),
    lastSearchCutoff: v.optional(v.boolean()),
    timeoutToken: v.optional(v.string()),
    expectedRevision: v.number(),
    attempts: v.number(),
